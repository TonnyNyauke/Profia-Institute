...
function SidebarLeft({handleShowComponent} : FunctionProps) {
  ...
  return (
    <div className='flex flex-col m-2 border-r border-blue-500 h-full'>
        ...
        <button className='w-9/12 border border-blue-500 rounded-md mb-4 px-2 py-2' onClick={() => handleShowComponent('set-months')}>Set Months</button>
        ...
        <button className='w-9/12 border border-blue-500 rounded-md mb-4 px-2 py-2' onClick={() => handleShowComponent('marketing-leads')}>Marketing $ Leads</button>
